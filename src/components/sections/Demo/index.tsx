...
export const Demo = () => {
    return (
        <section className="flex flex-col items-left px-10 pt-15 sm:flex-row sm:items-center md:px-15 lg:justify-between lg:px-20 xl:px-35" id="demo">
            <div className="p-6 rounded-lg mb-8 w-full sm:w-6/10 sm:mb-0 lg:w-5/10" style={{ backgroundColor: BRAND_COLORS.PROJECTS_BG }}>
                <h2 className="text-white mb-5 font-bold">Atributos chave</h2>
                <div className="flex items-center rounded-lg mb-4 py-2 px-3" style={{ backgroundColor: UI_COLORS.WHITE_OFF }}>
                ...
                <div className="flex items-center rounded-lg py-2 px-3" style={{ backgroundColor: UI_COLORS.WHITE_OFF }}>
                    <CircleCheckBig size={20} />
            ...
            <div className="sm:ml-10">
                ...
                <p className="text-justify text-sm mb-3 lg:text-base">Veja na prática como a UAI.py pode ser aplicada no dia a dia.</p>
